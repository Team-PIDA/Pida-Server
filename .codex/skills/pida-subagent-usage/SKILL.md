...
description: Use when you want to invoke PIDA project-scoped custom agents from the repository root. Gives ready-to-run Spawn-based command templates and prompt patterns for feature_mapper, ci_triager, api_reviewer, db_core_specialist, code_reviewer, and commit_push_guard.
metadata:
  short-description: Run PIDA custom agents with Spawn prompts
---
